...
#include <iostream>
#include <ros/ros.h>
#include <wm_vision/vision_interface_flow.h>
...
void MainWindow::StartVisionTree() {
	ros::NodeHandle n;
	ros::ServiceClient client = n.serviceClient<wm_vision::vision_interface_flow>("vision_kernel");
	wm_vision::vision_interface_flow srv;
